...
package com.aispeech.segment.dictionary.newImp;
...
public class AhoCorasickDoubleArrayTrie<V> implements Serializable
{
    ...
    public static void main(String[] args) {
        AhoCorasickDoubleArrayTrie dictionary = new AhoCorasickDoubleArrayTrie();
       ...
       Map<String,Word> words = new HashMap<>();
        ...
        System.out.println("查找 百度" + dictionary.parseText("百度是干什么的"));
    }
}
